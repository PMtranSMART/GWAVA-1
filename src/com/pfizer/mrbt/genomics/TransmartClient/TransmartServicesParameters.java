...
public class TransmartServicesParameters {
	 ...
	 */
	public final static String PRODUCTION_HOST = "amrndhl1038.pfizer.com:8000";
	// public final static String STAGE_HOST = "transmart.pfizer.com";
	public final static String STAGE_HOST = "amrndhl1040.pfizer.com:8000";
	public final static String TEST_HOST = "amre1al306.pcld.pfizer.com";
	// public final static String STAGE_HOST = "transmart.pfizer.com";
	public final static String DEV_HOST = "amre1al336.pcld.pfizer.com";
	public final static String TEST_URL = "http://" + TEST_HOST + ":" + PORT
			+ "/transmart/webservice/";
	public final static String STAGE_URL = "http://" + STAGE_HOST
			+ "/transmart/webservice/";
	public final static String DEV_URL = "http://" + DEV_HOST + ":" + PORT
			+ "/transmart/webservice/"; // yes there are 2 dev servers
	public final static String PROD_URL = "http://" + PRODUCTION_HOST
			+ "/transmart/webservice/";
